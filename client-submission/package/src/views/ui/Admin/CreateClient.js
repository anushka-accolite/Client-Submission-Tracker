...
//       console.log(accountManagerOptions);
//       // await Promise.all([
//       //   axios.put(`http://localhost:8092/api/user/${talentAcquisitionOptions[0].userId}`, { clientId: formData.clientId }, { headers }),
//       //   axios.put(`http://localhost:8092/api/user/${projectManagerOptions[0].userId}`, { clientId: formData.clientId }, { headers }),
//       //   axios.put(`http://localhost:8092/api/user/${accountManagerOptions[0].userId}`, { clientId: formData.clientId }, { headers })
//       // ]);
