...
public class SubmissionController {
	...
	@GetMapping("/{clientId}/candidates/{candidateId}/users/{userId}")
	public ResponseEntity<?> getSubmissionByClientCandidateAndUser(
			@PathVariable Integer clientId,
			@PathVariable Integer candidateId,
			@PathVariable Integer userId
	) {
		SubmissionToClient submission = submissionService.getSubmissionByClientCandidateAndUsers(clientId, userId, candidateId);
		if (submission != null) {
